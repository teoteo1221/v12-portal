...
import { WEEK_TYPE_EDITABLE, type WeekTypeDraft } from "@/lib/catalogs";
...
export async function DELETE(
  ...
  // Soft-delete. Los tipos de semana alimentan calendario + matriz + slots;
  // borrarlos físicamente rompería content_slots.week_type_id y cálculos
  // históricos de cycle_phase_on(date).
  const { data, error: updateError } = await supabase
    .from("week_types")
